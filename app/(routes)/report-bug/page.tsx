...
const ReportBug = () => {
  ...
  return (
    <div className="flex w-full min-h-screen justify-center items-center bg-gradient-to-r from-violet-300 to-fuchsia-300">
      <div className="w-full lg:w-auto grid grid-cols-1 md:grid-cols-2 lg:px-24 ">
        ...
        <div className="flex flex-col items-start px-12 lg:w-full lg:h-full bg-[#ffffff] shadow-xl text-[#203020] p-10 rounded-e-xl">
          ...
          <Form {...form}>
            ...
            >
              ...
              <Button type="submit" className="rounded-3xl px-10 bg-purple-700">
                Wyślij
              </Button>
            </form>
          </Form>
